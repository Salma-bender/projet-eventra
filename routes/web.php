...
*/
Route::get('/', function () {
    return redirect('/home'); // ou n'importe quelle autre route existante
});
...
Route::post('/feedback', [App\Http\Controllers\DemandeurController::class, 'submitFeedback'])->name('submitFeedback');
