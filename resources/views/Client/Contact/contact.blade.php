    ...
    <div class="breadcrumb-outer">
        <div class="container">
            <div class="breadcrumb-content text-center pt-14 pb-2">
                <h5 class="theme mb-0">Eventra</h5>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="info-item bg-grey px-4 py-5 border-all text-center">
                            ...
                            <div class="info-content">
                                <h5>Marrakech</h5>
<p class="mb-0">Faculté des Sciences Semlalia, Route Abdelkarim El Khatabi</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    <div class="col-lg-4 col-md-12 mb-4">
                        <div class="info-item bg-grey px-4 py-5 border-all text-center">
                            ...
                            <div class="info-content ps-4">
                                <h5>Email</h5>
                                <p class="m-0">salmabender11@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 ps-lg-4 mb-4">
                            <div class="map">
                              ...
                              <div style="width: 100%">
    <iframe height="500" src="https://maps.google.com/maps?q=Facult%C3%A9%20des%20Sciences%20Semlalia%20Marrakech&t=&z=17&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
