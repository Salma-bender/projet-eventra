...
<body>
	...
	<section class="fxt-template-animation fxt-template-layout8" data-bg-image="log.jpg">
		<div class="fxt-content">
			<div class="fxt-header">
				<a href="{{route('home')}}" class="fxt-logo"><img src="client/images/monlogo1.png" alt="Logo"></a>
			</div>
			<div class="fxt-form">
        ...
        <button type="submit" class="fxt-btn-fill">Register</button>
			...
			<div class="fxt-footer">
				<div class="fxt-transformY-50 fxt-transition-delay-9">
					<p style="color: rgb(58, 126, 64); font-weight: bold; "> Vous avez déjà un compte ? <a href="{{ route('login') }}" class="switcher-text2 inline-text" style="color: rgb(178, 56, 56); font-weight: bold;"  >Connectez-vous ici</a></p>
				</div>
			</div>
		</div>
	</section>
