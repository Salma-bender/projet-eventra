...
<head>
    ...
    <meta charset="utf-8">
    <title>Form Validation | Eventra - Admin & Dashboard Template</title>
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h6 class="page-title">Page Categories </h6>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card" style="text-align: center;">
                                <div class="card-body">
                                    ...
                                    <form method="post" action="{{url('AddCategory')}}" name="contactform2" id="contactform2" class="row g-3 ">
                                        @csrf
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary" href="{{ url('AddCategory') }}" onclick="event.preventDefault();
                                                     document.getElementById('contactform2').submit();" type="submit">Submit form</button>
                                        </div>
                                        <!-- end col -->
                                    </form><!-- end form -->
                                </div><!-- end cardbody -->
