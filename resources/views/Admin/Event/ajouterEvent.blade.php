...
<head>
    ...
    <meta charset="utf-8">
    <title>Eventra - Admin & Dashboard Template</title>
...
<body data-sidebar="dark">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="index.html" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="assets/images/monlogo1.png" alt="" height="22">
                            </span>
                            <span class="logo-lg">
                                <img src="assets/images/monlogo1.png" alt="" height="17">
                            </span>
                        </a>

                        <a href="{{route('admin')}}" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="{{ asset('monlogo1.png') }}" alt="" height="40">
                            </span>
                            <span class="logo-lg">
                                <img src="{{ asset('client/images/monlogo1.png') }}" alt="" height="50">
                            </span>
                        </a>
                    </div>
    ...
    <select name="Location" class="form-control" required>
        ...
        <option value="Casablanca" @if(old('Location')==='Casablanca' ) selected @endif>Casablanca</option>
        <option value="Rabat" @if(old('Location')==='Rabat' ) selected @endif>Rabat</option>
        <option value="Marrakech" @if(old('Location')==='Marrakech' ) selected @endif>Marrakech</option>
        <option value="Fès" @if(old('Location')==='Fès' ) selected @endif>Fès</option>
        <option value="Tanger" @if(old('Location')==='Tanger' ) selected @endif>Tanger</option>
        <option value="Agadir" @if(old('Location')==='Agadir' ) selected @endif>Agadir</option>
        <option value="Meknès" @if(old('Location')==='Meknès' ) selected @endif>Meknès</option>
        <option value="Oujda" @if(old('Location')==='Oujda' ) selected @endif>Oujda</option>
        <option value="Laâyoune" @if(old('Location')==='Laâyoune' ) selected @endif>Laâyoune</option>
        <option value="Errachidia" @if(old('Location')==='Errachidia' ) selected @endif>Errachidia</option>
        <option value="Beni Mellal" @if(old('Location')==='Beni Mellal' ) selected @endif>Beni Mellal</option>
        <option value="Tétouan" @if(old('Location')==='Tétouan' ) selected @endif>Tétouan</option>
        <option value="Khouribga" @if(old('Location')==='Khouribga' ) selected @endif>Khouribga</option>
        <option value="El Jadida" @if(old('Location')==='El Jadida' ) selected @endif>El Jadida</option>
        <option value="Safi" @if(old('Location')==='Safi' ) selected @endif>Safi</option>
        <option value="Taroudant" @if(old('Location')==='Taroudant' ) selected @endif>Taroudant</option>
        <option value="Nador" @if(old('Location')==='Nador' ) selected @endif>Nador</option>
        <option value="Ouarzazate" @if(old('Location')==='Ouarzazate' ) selected @endif>Ouarzazate</option>
        <option value="Kénitra" @if(old('Location')==='Kénitra' ) selected @endif>Kénitra</option>
        <option value="Essaouira" @if(old('Location')==='Essaouira' ) selected @endif>Essaouira</option>
        <option value="Guelmim" @if(old('Location')==='Guelmim' ) selected @endif>Guelmim</option>
        <option value="Taza" @if(old('Location')==='Taza' ) selected @endif>Taza</option>
        <option value="Al Hoceima" @if(old('Location')==='Al Hoceima' ) selected @endif>Al Hoceima</option>
        <option value="Settat" @if(old('Location')==='Settat' ) selected @endif>Settat</option>
    </select>
</div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        </script> Eventra<span class="d-none d-sm-inline-block"> - Crafted with <i class="mdi mdi-heart text-danger"></i> by Salma&Nouhaila.</span>
                    </div>
                </div>
            </div>
        </footer>
